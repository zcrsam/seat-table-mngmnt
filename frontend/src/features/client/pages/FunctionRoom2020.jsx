...
export default function FunctionRoom2020() {
  ...
  useEffect(() => {
    ...
    const syncWithDatabase = async () => {
      try {
        ...
        console.warn("[FunctionRoom2020] Seat sync failed:", err.message);
      }
    };
  ...
  return (
    <div style={s.root}>
      <MainWingNavbar active="20/20 FUNCTION ROOM" />
      ...
      <div style={{ ...s.page, ...(isMobile ? { padding: "16px 14px" } : isTablet ? { padding: "24px 20px" } : {}) }}>
        ...
        <p style={s.pageSubtitle}>Book your preferred table in the Main Wing of 20/20 Function Room</p>
